...
public class TaskDTO extends CommonDTO {
    ...
    private final StringProperty dueDateDetailDesc = new SimpleStringProperty();
    ...
    public TaskDTO(Task t) {
        ...
        if (getDueDate() != null) {
            dueDateDetailDesc.bind(Bindings.createStringBinding(() -> DateTimeUtil.formatUserFriendlyDueDate(
                    dueDate.get()
            ), dueDate));
            dueDateDesc.bind(Bindings.createStringBinding(() -> DateTimeUtil.dateToString(dueDate.get(), DateTimeConstant.STANDARD_12_HOUR_DATE_MINUTE_FORMAT), dueDate));
        }

        if (getStartDate() != null) {
            startDateDesc.bind(Bindings.createStringBinding(() -> DateTimeUtil.dateToString(
                    startDate.get(), DateTimeConstant.STANDARD_12_HOUR_DATE_MINUTE_FORMAT
            ), startDate));
        }
    ...
    public String getStartDateDesc() {
        return startDateDesc.get();
    }

    public StringProperty startDateDescProperty() {
        return startDateDesc;
    }

    public void setStartDateDesc(String startDateDesc) {
        this.startDateDesc.set(startDateDesc);
    }
    ...
    public String getDueDateDesc() {
        return dueDateDesc.get();
    }

    public StringProperty dueDateDescProperty() {
        return dueDateDesc;
    }

    public void setDueDateDesc(String dueDateDesc) {
        this.dueDateDesc.set(dueDateDesc);
    }
    ...
    public String getPriorityDesc() {
        return priorityDesc.get();
    }

    public StringProperty priorityDescProperty() {
        return priorityDesc;
    }

    public void setPriorityDesc(String priorityDesc) {
        this.priorityDesc.set(priorityDesc);
    }

    public StringProperty dueDateDetailDescProperty(){
        return dueDateDetailDesc;
    }
}